...
const static int N_ob = alpha; // Size of operation block in N dimension in terms of tiles
...
const static int M_sr = 2*M_ob; 
const static int K_sr = 2*K_ob;
const static int N_sr = 2*N_ob;
